...
<script langauge="javascript"> 
   //var taskObj = parent.window.dialogArguments;
   var taskObj = art.dialog.data('data');
            
   //初始化任务属性值
   function initTaskValues(){
      document.all.name.value = taskObj.wfTaskName;
      document.all.innerTaskID.value = taskObj.wfTaskInnerID;
      document.all.description.value = taskObj.descript;
   }
   
   //保存任务属性值
   function saveTaskValues(){
      taskObj.wfTaskName = document.all.name.value;
      taskObj.wfTaskInnerID = document.all.innerTaskID.value;
      taskObj.descript = document.all.description.value;
      window.close();
   }
</script>
<body scroll="no">
		  	...
		  	<tr >
               ...
               <tr >
                ...
                <tr >
                  ...
                  <td class="tdinput"  width="35%">
                     <input type="text" class="input_text" name="preview" id="preview" 
                        value="">
                  </td>                         
               </tr>
               <tr >
                  <td class="label"  width="15%">后续任务节点InnerID：</td>
                  <td class="tdinput"  width="35%">
