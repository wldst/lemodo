...
<script type="text/javascript">
	...
	$(function() {
		...
		var params = {};
		// 初始化查询列表
		initDataGrid('grid-workflow-list','${contextPath}/workflowForm/initTemplateList.so',params,frozenColumns,columns,false,'ID',false);
   ...
   function initWfInstanceList(_idx){
	   var data = $("#grid-workflow-list").datagrid("getRows")[_idx];
		var templateMark = data.TEMPLATEMARK;
     var listUri = "${contextPath}/workflowForm/toWfInsList.so?wfTempMark=" + templateMark;
