...
public class GLMChatQuestion  extends WebSocketListener{
...
//        chat();
    ...
    public GLMChatQuestion(String question) {
	super();
	this.question = question;
    }


    public static GLMChatQuestion chat(String question,String myId) {
	 GLMChatQuestion chatQuestion = new GLMChatQuestion(question);
	try {
            //构建鉴权httpurl
