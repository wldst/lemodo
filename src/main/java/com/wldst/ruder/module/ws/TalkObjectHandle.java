...
@ServerEndpoint("/ws/talk/object")
@Service
public class TalkObjectHandle {
    public static Logger logger = LoggerFactory.getLogger(TalkObjectHandle.class);

    private Process process;
    private InputStream inputStream;
    private static Map<String, Map<String, String>> sessionProp = new HashMap<>();
    private static Map<String, TalkObjectHandle> sessionMap = new HashMap<>();

    // 用来存放每个客户端对应的MyWebSocket对象。
    private static CopyOnWriteArraySet<TalkObjectHandle> webSocketSet = new CopyOnWriteArraySet<TalkObjectHandle>();
	...
	for (TalkObjectHandle hi : webSocketSet) {
	...
	TalkObjectHandle rlHandle = sessionMap.get(sessionId);
	if (rlHandle == null) {
