...
import com.wldst.ruder.openai.BdChatQuestion;
/**
 * 查询谁的属性是什么，关系有哪些
 * 
 * @param msg
 ...
 */
@Component
public class BdChat extends ParseExcuteDomain implements MsgProcess {
    
    final static Logger logger = LoggerFactory.getLogger(BdChat.class);
